...
from pyoperators import (
    Operator, IdentityOperator, ReshapeOperator, SwapAxesOperator)
...
def test_reshape_composition():
    ...
    shape2 = (24,)
    shape3 = (4, 3, 2, 1)
    assert_equal(ReshapeOperator(shape2, shape3) * ReshapeOperator(shape1, shape2), ReshapeOperator(shape1, shape3))
...
def test_swapaxes_composition():
    ...
    a3 = 3
    raise SkipTest()
    assert_equal(SwapAxesOperator(a2, a3) * SwapAxesOperator(a1, a2),
                 SwapAxesOperator(a1, a3))
