...
brackets = (bracket(1, 2), bracket(1, 3), bracket(1, 1), bracket(0, 1),
            bracket(3, 3), bracket(-1, 2))
...
def test_bracket_contains():
    ...
    brackets2 = (bracket(0, 0), bracket(0, 1), bracket(1, 1), bracket(0, 2),
                 bracket(1, 2))
    expecteds = ((True, True, False, True, False),
...
def test_bracket_intersection():
    ...
    expecteds = ((bracket(-1, 0), bracket(0, 0), bracket(0, 0), bracket(0, 0)),
